package com.bessada.data.vo.v1.security;
...
public class TokenVO implements Serializable {
	...
	@Override
	public int hashCode() {
		return Objects.hash(accessToken, authenticaded, created, expiration, refreshToken, username);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(accessToken, other.accessToken) && Objects.equals(authenticaded, other.authenticaded)
